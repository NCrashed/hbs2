...
--
-- NOT bumped for 'RpcMailboxPoWFloor', and the difference is
...
--
-- Bumped again for the stamp on 'RpcMailboxDeleteMessages',
...
-- neighbours have published in their meta. It reaches one hop:
